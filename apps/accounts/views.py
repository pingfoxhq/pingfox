...
def register_view(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        messages.success(request, "Registration successful! Please check your email for activation code.")
...
def edit_user_view(request):
    ...
    """
    uform = UserEditForm(
        request.POST or None or None, instance=request.user
    )
    ...
    if request.method == "POST" and uform.is_valid() and pform.is_valid():
        ...
        return redirect("accounts:edit_user_view")
