    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_token', models.CharField(default=apps.sites.models.generate_verification_token, help_text='A unique token used to verify ownership of the site. Place this in a file at the root of your domain as ~/.well-known/pingfox-verification.txt. ', max_length=256, unique=True, verbose_name='Verification Token')),
                ...
                ('form', models.ForeignKey(blank=True, help_text='The form associated with this site, if any.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sites', to='forms.form', verbose_name='Form')),
                ...
                ('team', models.ForeignKey(help_text='The team that owns this site.', on_delete=django.db.models.deletion.CASCADE, related_name='sites', to='teams.team', verbose_name='Team')),
            ],
            options={
                'verbose_name': 'Site',
